    ...
    <section className="demo-card" aria-labelledby="demo-title">
      <div className="demo-heading">
        ...
        <div>
          ...
          <h2 id="demo-title">Explore with demo data</h2>
        </div>
      </div>
      <p className="demo-description">
        Everyday purchases, a few treats, and the bills in between. Bring your calendar, ledger, and
        budget to life.
      </p>
      ...
      <p className="demo-hint">
        Your entries and settings stay yours. Example limits are added only to an empty,
        unconfigured tracker. Safe to click again.
      </p>
      <p className="demo-feedback" role="status">
        {result &&
          ...
          (result.added
            ...
            : 'Demo expenses are already present. Your edits were kept.')}
      </p>
      {result?.error && (
