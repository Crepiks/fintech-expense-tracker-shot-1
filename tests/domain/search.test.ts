...
const expenses: Expense[] = [
  { id: 'a', date: '2026-09-10', description: 'Lunch with Aida', category: 'Food', amountMinor: 2000, createdAt: 1 },
  { id: 'b', date: '2026-09-17', description: 'Bus home', category: 'Transportation', amountMinor: 2500, createdAt: 2 },
  { id: 'c', date: '2026-09-18', description: 'Lunch alone', category: 'Food', amountMinor: 1000, createdAt: 3 },
  { id: 'd', date: '2026-08-10', category: 'Other', amountMinor: 5000, createdAt: 4 },
];
const search = (query: string, month = '2026-09') => filterExpenses(expenses, query, month).map(item => item.id);
...
it.each([
  ['>20', ['b', 'd']], ['<20', ['c']], ['<=20', ['a', 'c']], ['=20', ['a']],
  ['>0', ['a', 'b', 'c', 'd']], ['=0', []], ['>=25.00', ['b', 'd']],
...
it.each(['#unknown', '#', '>wat', '>1.234', '>999999999999999', '>=', 'note:', 'sep 17..10', 'feb 29..30', '2026-09-18..2026-09-10', '2026-00-01..2026-09-10', '2026-09-10..2026-09-17..2026-09-20', 'sep 10..', '10..17', 'amount:20'])('returns no matches for malformed search %s', (query) => {
