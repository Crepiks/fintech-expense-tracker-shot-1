...
it('filters the ledger and opens a real budget view', () => {
  localStorage.setItem(
    ...
    JSON.stringify({
      ...data,
      expenses: [expense, { ...expense, id: 'bus', category: 'Transportation', amountMinor: 2000 }],
    }),
  );
  render(<App />);
  navigate('ledger');
  ...
  expect(
    screen.queryByRole('button', { name: 'Edit Transportation expense' }),
